...
const AddToCart = ( {product, addCart, obs} ) => {
    ...
    return (
        <div className="wrapper-button-product">
            ...
            <button className='add-cart' onClick={() => addCart(product._id, count, totalPriceProduct)} onMouseDown={() => addMessageToArray(product.name, count, obs , product._id)} onMouseUp={() => addTotalPrice(product._id, totalPriceProduct)}> 
